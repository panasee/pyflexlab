import time
from qcodes_contrib_drivers.drivers.Thorlabs.KDC101 import Thorlabs_KDC101
from qcodes_contrib_drivers.drivers.Thorlabs.K10CR1 import Thorlabs_K10CR1
from qcodes_contrib_drivers.drivers.Thorlabs.PM100D import Thorlab_PM100D
...
class LaserSys:
    def __init__(self):
        ...
        self.ports = {
            "PM100D": "USB0::0x1313::0x8078::P0032564::INSTR", # P1005549
            "PM100D_2": "USB0::0x1313::0x8078::PM003618::INSTR", # P1005549v
            "FLU15": "COM6",
            "SC10": "COM1",
        }
        ...
        self.kdc101 = Thorlabs_KDC101("kdc101", "27005380")
        self.k10cr1 = Thorlabs_K10CR1("k10cr1", "55455804")
        self.switch_dict = {
            "PM100D": True,
            "PM100D_2": True,
            "FLU15": True,
    ...
    def _load_instruments(self):
        self.pm100d = Thorlab_PM100D("pm100d", self.ports["PM100D"]) if self.switch_dict["PM100D"] else None
        self.pm100d_2 = Thorlab_PM100D("pm100d_2", self.ports["PM100D_2"]) if self.switch_dict["PM100D_2"] else None
        # mot
        self.k10cr1 = Thorlabs_K10CR1("k10cr1", self.serial_no["ThorK10CR1"]) if self.switch_dict["ThorK10CR1"] else None
        # polar
        self.k10cr1_2 = Thorlabs_K10CR1("k10cr1_2", self.serial_no["ThorK10CR1_2"]) if self.switch_dict["ThorK10CR1_2"] else None
        ...
        self.shutter = Shutter(self.serial_no["KSC101SH05"]) if self.switch_dict["KSC101SH05"] else None
    ...
    def _init_instruments(self):
        ...
        if self.shutter:
            self.shutter.operatingstate = "manual"
    ...
    def poweralign(self, wavelength, power):
        ...
        self.shutter.operatingstate = "inactive"
        time.sleep(2)
        outcell = _get_power()
        ...
        time.sleep(2)
        self.shutter.operatingstate = "active"
        time.sleep(2)
        outcell = _get_power()
