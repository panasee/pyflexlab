...
class ThorlabsKDC101(
    IDCPIDParameters, IDeviceScanning, GenericKCubeMotorCLI, ThorlabsQcodesInstrument
):
    """
    ...
    def _import_device_dll(self):
        ...
        self._import_dll_class(
            "Thorlabs.MotionControl.KCube.DCServoCLI", "KCubeDCServo"
        )
    ...
    def _post_enable(self):
        ...
        self._api_interface.SetSettings(
            self._api_interface.MotorDeviceSettings, True, False
        )
        sleep(0.5)
