...
class ILaserSource(IGenericDeviceCLI, IGenericCoreDeviceCLI):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.add_parameter(
            ...
            set_cmd=lambda x: self._set_thorlabs_enum(
                x, setter_name="SetControlSource"
            ),
            val_mapping={
                "Software": 0,
                "Software, External": 1,
        ...
        self.add_parameter(
            ...
            set_cmd=lambda x: self._api_interface.SetOn()
            if x
            else self._api_interface.SetOff(),
