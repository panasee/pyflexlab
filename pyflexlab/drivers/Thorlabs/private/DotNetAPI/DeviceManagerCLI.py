...
class IGenericCoreDeviceCLI:
    ...
    def connect(self):
        ...
        try:
            ...
            self.log.exception(
                f"Failed to connect to instrument with serial number {self._serial_number}"
            )
            raise
...
class IGenericRackDevice:
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not isinstance(self, IGenericCoreDeviceCLI):
            raise TypeError(
                "IGenericRackDevice should only be mixed with "
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if not isinstance(self, ThorlabsMixin):
            raise TypeError(
                "IGenericDeviceCLI should only be mixed with "
        ...
        self._set_startup_mode_value(
            kwargs.pop("startup_mode_value", startup_mode_value)
        )
    ...
    def _edit_startup_mode(self) -> None:
        ...
        if hasattr(self, "_dll"):
            ...
            if hasattr(self.parent._dll, "DeviceConfiguration"):
                mode_enum = (
                    self.parent._dll.DeviceConfiguration.DeviceSettingsUseOptionType
                )
        ...
        if mode_enum is not None:
            ...
            raise AttributeError(
                "Neither self nor parent has '_dll.DeviceConfiguration'"
            )
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self._get_thorlabs_attribute("CanDeviceLockFrontPanel"):
            self.add_parameter(
                ...
                get_cmd=lambda: self._get_thorlabs_attribute(
                    getter_name="GetFrontPanelLocked"
                ),
                set_cmd=lambda x: self._set_thorlabs_attribute(
                    x, getter_name="SetFrontPanelLock"
                ),
                val_mapping=create_on_off_val_mapping(on_val=True, off_val=False),
            )
