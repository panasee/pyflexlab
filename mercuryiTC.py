...
class MercuryiTC(VisaInstrument):
    ...
    def __init__(self, name, address="TCPIP0::10.21.28.24::7020::SOCKET", probe_temp='DEV:DB8.T1:TEMP',
                 ...
                 pressure='DEV:DB5.P1:PRES', needle_valve='DEV:DB4.G1:AUX', vti_temp='DEV:MB1.T1:TEMP',
                 vti_heater='DEV:MB0.H1:HTR', **kwargs):
        ...
        self.modules = [self.probe_heater_str, self.probe_temp_str, self.pressure_str, self.needle_valve_str,
                        self.vti_temp_str, self.vti_heater_str]
    ...
    @staticmethod
    def _print_temp_status(start, current, stop):
    ...
    def _set_vti_temp(self, target):
        ...
        self.vti_temp_setpoint(target)  # set desired set point on the heater
        sleep(1)
        self.device_clear()

    def _calculate_vti_temp(self, probe_temp):
        """
        Function to calculate the optimum VTI temperature set point as a function of the probe temperature setpoint, as described in the Spectromag manual.
        """
